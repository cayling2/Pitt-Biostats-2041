...
#NA placeholder since the vector is shorter than that
x_vector[1:6]
```
...
```{r}
# logical value
#is the length equal to 4 <- FALSE
...
# Likert scale
#levels for the data and labels to go with those levels (need to be the same length)
x_vector <- c(x_vector, 1, 3)
...
#Fixed code that doesn't give error
#can also start in directory you are in then doing "Data/ArthritisTreatment.csv"
ra <- read_csv(file = "C:/Users/cayli/Desktop/Biostats 2041/Pitt-Biostats-2041/Data/ArthritisTreatment.csv")
