...
# make sure to add this to every project
...
#tick marks are by the 1

#make code chunk to include data importing code
library(readr)
RA <- read_csv("Recitations/R1/ArthritisTreatment.csv")
View(RA)
...
list.files(path = "Recitations/R1")

# to list the files with their full path names, we can add an extra argument
list.files(path = "Recitations/R1", full.names = TRUE)
```
...
read_csv(file = "Recitations/R1/ArthritisTreatment.csv")

#forgot to name the data (arrow/assign operator)   
# This allows it to be saved in the environment
RA2 = read_csv(file = "Recitations/R1/ArthritisTreatment.csv")
...
#variable in consol vs codde chunk matter for working with data 
...
RA3 = read_csv("/Users/cayli/Desktop/Biostats 2041/Pitt-Biostats-2041/Recitations/R1/ArthritisTreatment.csv")
